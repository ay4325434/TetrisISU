...
public class SongConstants {
    ...
    public static final Map<Integer, List<String>> SONG_ORDERS = Map.of(
            ...
            4, List.of("collectionD10", "collectionD1", "collectionD3", "collectionD5", "collectionD7",
                    "collectionD8", "collectionD9", "collectionD4", "collectionD6", "collectionD2"),
            5, List.of("collectionE10", "collectionE3", "collectionE2", "collectionE4", "collectionE6",
                    "collectionE8", "collectionE9", "collectionE5", "collectionE7", "collectionE1"),
            6, List.of("collectionF2", "collectionF3", "collectionF6", "collectionF9", "collectionF8",
                    "collectionF1", "collectionF10", "collectionF7", "collectionF4", "collectionF5"),
            7, List.of("collectionG1", "collectionG10", "collectionG7", "collectionG2", "collectionG5",
                    "collectionG3", "collectionG4", "collectionG6", "collectionG8", "collectionG9"),
            8, List.of("collectionH4", "collectionH6", "collectionH5", "collectionH8", "collectionH2",
                    "collectionH10", "collectionH7", "collectionH1", "collectionH3", "collectionH9"),
            9, List.of("collectionI9", "collectionI4", "collectionI3", "collectionI7", "collectionI2",
                    "collectionI10", "collectionI1", "collectionI6", "collectionI5", "collectionI8"),
            10, List.of("collectionJ1", "collectionJ10", "collectionJ8", "collectionJ6", "collectionJ2",
    ...
    public static final Map<Integer, List<String>> IMAGE_ORDERS = Map.of(
            ...
            6, List.of("F2", "F3", "F6", "F9", "F8", "F1", "F10", "F7", "F4", "F5"),
            7, List.of("G1", "G10", "G7", "G2", "G5", "G3", "G4", "G6", "G8", "G9"),
            8, List.of("H4", "H6", "H5", "H8", "H2", "H10", "H7", "H1", "H3", "H9"),
            9, List.of("I9", "I4", "I3", "I7", "I2", "I10", "I1", "I6", "I5", "I8"),
            10, List.of("J1", "J10", "J8", "J6", "J2", "J9", "J4", "J7", "J5", "J3")
    );
}
