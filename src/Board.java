...
public class Board extends JPanel implements Runnable, MouseListener, MouseMotionListener {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(gm.isSelectingSong()) {
            ...
            if(GameManager.mc11.contains(p)){
                if(gm.isSelectionActivated()){
                    gm.saveSongCollection(11);
                }
                else {
                    gm.selectCollection(11);
                }
            }
            if(GameManager.mc12.contains(p)){
                if(gm.isSelectionActivated()){
                    gm.saveSongCollection(12);
                }
                else {
                    gm.selectCollection(12);
                }
            }
